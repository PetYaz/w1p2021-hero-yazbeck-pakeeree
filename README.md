...
URL du site : https://hero-pakeeree-yazbeck.netlify.com/
...
| État | Le choix du personnage et/ou de ses caractéristiques impacte l'aventure au moins une fois. **La soupe peut se renverser et provoquer un game over même si le temps impartie est respecté.** | Oui |
...
| État | Le choix du personnage et/ou ce qu'il s'est passé pendant l'aventure impactent l'écran de fin. **Plusieurs écrans de fin en fonction de la façon de perdre (renversé, manque de temps, mort)** | Oui |
